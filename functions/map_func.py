...
def get_address_from_coords(coords):
    ...
    try:
        ...
        return "Не могу определить адрес по введенным данным.\n\nОтправь мне свою геолокацию или координаты в " \
               "формате (долгота, широта) "


# Нужно, чтобы бот отправил такое сообщение в самом начале при кнопке карты
# Отправь мне свою геолокацию или координаты в формате (долгота, широта)
