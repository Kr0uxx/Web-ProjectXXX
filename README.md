...
Descardic ( имя нашего бота ) может запрашивать локацию у пользователя, работает с файлами и со множеством различных API. Помимо этого в проекте было показано умение работать с  библиотекой beautifulsoup4, которая используется в функциях про валюту, крипту и не только. Также есть orm-модели и DB ( считаем кол-во /start пользователя ) 
